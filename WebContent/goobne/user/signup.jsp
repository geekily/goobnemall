				...
				<div class="infoTbl clB">
					<table>
						...
						<tr>
							...
							<td>
								<input type="password" id="lgn_pwd" name="pwd" style="width:235px;" title="비밀번호""><span class="cmnt">영, 숫자만, 특수문자 혼용하여 6~15자리 사용 가능합니다.</span>
							</td>
						</tr>
						<tr>
						...
						<tr align="center">
							<td height="40" class="orderBtnWrap btn3 alC" align="center">
								<button class="btnBuy" type="button" onclick="sendIt();">회원가입</button>
							</td>
						</tr> 
						</table>
						</tbody>

...
<div class="flR">
	...
	<div class="inputWrap">
		...
		style="width:262px" title="주문번호를 입력해 주세요." placeholder="주문번호를 입력해 주세요." aria-required="true">
		<input type="text" name="mble" class="lgn placeholder required" 
		style="width:262px" title="휴대번호('-'없이)를 입력해 주세요." placeholder="휴대번호('-'없이)를 입력해 주세요." aria-required="true">

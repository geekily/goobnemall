...
<div id="contents">
	...
	<div class="prdtTitWrap">
		<p class="prdtCmnt"></p>
		<h4 class="prdtTit">${dto.productName }</h4>
	</div>
	...
	<a href="#none" class="btnD openLyBtn">영양분석표</a>
		...
		<div class="lyCont"><br/>
		<h6 align="center">그게 왜 궁금해요...?</h6><br/>
	...
	<div class="deliDate">
		<dl><dt>배송예정일</dt>
		<dd id="dlv_arrvl_dt_txt">2020.11.17</dd></dl>
			<p class="cmnt">기본배송일 보다 늦게 수령을 하시고자 할때 희망 배송예정일을 선택해 주세요.</p>
			<p></p>
	...
	<div class="selectDate">
		<input type="text" name="dlv_arrvl_dt" id="dlv_arrvl_dt"
		class="date" value="2020.11.17" title="배송예정일" readonly />
	</div>
	</div>

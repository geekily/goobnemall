...
<script type="text/javascript">
	...
	function sendIt(){
		...
		if(f.noMemberPolicyAgree.checked==false){
			alert("비회원 개인정보 수집에 동의해야만 진행할 수 있습니다.");
			f.noMemberPolicyAgree.focus();
			return;
		}
	...
	function noMemberPolicyAgreeCheck(){
		
		var f=document.myForm;
		
		if(f.noMemberPolicyAgree.checked){
			f.noMemberPolicyDisagree.checked=false;
		}
	}
	
	function noMemberPolicyDisagreeCheck(){
		
		var f=document.myForm;
		
		if(f.noMemberPolicyDisagree.checked){
			f.noMemberPolicyAgree.checked=false;
		}
	}
...
<form action="" name="myForm" method="post">
	<table border="0" width="1000" align="center" cellspacing="0">
		<tr height="80">
			<td width="25%" align="left">
				<font size="6"><b>주문서작성/결제</b></font>
			</td>
			<td align="right" colspan="2">
				01장바구니 02주문서작성/결제 03주문완료
			</td>
		</tr>
		
		<tr height="40">
			<td align="center" style="border-left: solid;border-top: solid;border-right: solid;border-width: thin;">
				<font size="5">
					<b>일반배송</b>
				</font>
			</td>
			<td align="right" style="border-bottom: solid;border-width: thin;">
				<font size="2">배송지별 총주문금액이 <font color="orange">총 30,000원 이상 시에는 배송비가 무료</font>입니다.</font>
			</td>
		</tr>
	</table>
	...
	<table border="0" width="1000" align="center" cellspacing="0">
		<tr height="50">
			<td width="25%" align="left">
				<font size="5"><b>주문자 정보</b></font>
			</td>
			<td align="right" colspan="2">
				<span class="icon required"></span>
				<font size="2">항목은 필수입력 값입니다.</font>
			</td>
		</tr>
	</table>
		...
		<tr height="50">
			...
			<td colspan="2" valign="middle" style="border-bottom: solid;border-bottom-color: #BDBDBD;border-bottom-width: 1px;">
				...
				<select name="buyerEmailSel" onchange="emailCheck();" style="width: 150px;height: 28px;border-color: #BDBDBD;border-width: 1px;">
					...
					<option value="hanamil.net">hanamil.net</option>
	...
	<table border="0" width="1000" align="center" cellspacing="0" >
		<tr height="50">
			<td width="25%" align="left">
				<font size="5"><b>배송지 정보 입력</b></font>
			</td>
			<td align="right" colspan="2">
				<input type="checkbox" name="sameInfo" onclick="sameInfoCheck();">
				<label for="copy_orderer_info">주문자 정보와 동일</label>
			</td>
		</tr>
	</table>
	...
	<table border="0" width="1000" align="center" cellspacing="0">
		...
		<tr height="50">
			<td width="85%" align="center" bgcolor="#EAEAEA" style="border-bottom: solid;border-bottom-color: #BDBDBD;border-bottom-width: 1px;">
				<font size="2"><b>상품</b></font>
			</td>
			<td width="15%" align="center" bgcolor="#EAEAEA" style="border-bottom: solid;border-bottom-color: #BDBDBD;border-bottom-width: 1px;">
				<font size="2"><b>상품금액</b></font>
			</td>
		</tr>
	</table>
	...
	<table border="0" width="1000" align="center" cellspacing="0">
		...
		<tr height="50">
			...
			<td width="70%" align="left" style="border-bottom: solid;border-bottom-color: #BDBDBD;border-bottom-width: 1px;">
				<font size="2">&nbsp;&nbsp;${dtoCart.productName }</font>
			</td>
			<td rowspan="2"  width="15%" align="center" style="border-bottom: solid;border-bottom-color: #BDBDBD;border-bottom-width: 1px;border-left: solid;border-left-color: #BDBDBD;border-left-width: 1px;">
				<font size="2"><b>${dtoCart.price }원</b></font>
			</td>
		</tr>
				<tr height="50">
			<td width="70%" align="left" style="border-bottom: solid;border-bottom-color: #BDBDBD; border-bottom-width: 1px;">
				<font size="2">&nbsp;&nbsp;1개 가격 :&nbsp;&nbsp;&nbsp;${dtoCart.price/dtoCart.qty }원&nbsp;&nbsp;&nbsp;/
	...
	<table border="0" width="700" align="left" cellspacing="0" style="margin-left: 16.6%;">
		<tr height="50">
		...
		<tr height="50">
			<td align="left" valign="bottom">
				<font size="4" style="letter-spacing: 0.1px;font-family: 굴림;"><b>비회원 주문을 위한 개인정보 수집 및 이용 동의서 (필수)</b></font>
			</td>
			<td align="left">
				<input type="button" value="개인정보 취급방침" align="top" style="background-color: transparent;border-color: black;margin-top: 14px;" onclick="window.open('<%=cp %>/goobnemall/personalInformationPolicy.do','window_name','width=420,height=620,location=no,status=no,scrollbars=no');">
			</td>
		</tr>
		
		<tr>
			<td align="left">
				<font size="1" style="letter-spacing: 1px;">주문, 배송을 위해 회원님께서 입력하신 정보의 권리는 굽네몰의 개인정보취급방침에 준합니다.</font>
			</td>
		</tr>
		
		<tr>
			<td colspan="2" height="150" align="center">
				<textarea rows="" cols=""  readonly="readonly" style="width: 96%;height: 90%;background-color: transparent;overflow-x:hidden;overflow-y:auto">
제1조(목적)
이 약관은 (주)지앤몰(전자상거래 사업자)(이)가 운영하는 굽네몰(이하 "몰"이라 한다)에서 제공하는 인터넷 관련 서비스(이하 "서비스"라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리·의무 및 책임사항을 규정함을 목적으로 합니다. ※「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다」

제2조(정의)
① "몰" 이란 (주)지앤몰(이)가 재화 또는 용역(이하 "재화등"이라 함)을 이용자에게 제공하기 위하여 컴퓨터등 정보통신설비를 이용하여 재화등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.
...
② "몰"과 이용자간에 제기된 전자상거래 소송에는 한국법을 적용합니다.
		...
		<tr>
			<td colspan="2" align="right">
				<input type="checkbox" name="noMemberPolicyAgree" onclick="noMemberPolicyAgreeCheck();"/> 동의함
				<input type="checkbox" name="noMemberPolicyDisagree" onclick="noMemberPolicyDisagreeCheck();"/> 동의안함
			</td>
		</tr>
	</table>
	...
	<table border="0" width="700" align="left" cellspacing="0" style="margin-left: 16.6%;">
		...
		<tr height="50">
			<td align="left" valign="bottom">
				<font size="4" style="letter-spacing: 0.1px;"><b>결제수단선택</b></font>
			</td>
		</tr>
	...
	<table border="0" width="300" align="center" cellspacing="0" style="margin-right: 16.6%;">
		<tr height="68">
			<td colspan="3" valign="bottom" style="border-bottom: solid;border-bottom-width: 2px;">
				<font size="5"><b>최종 결제정보</b></font>
			</td>
		</tr>
		
		<tr height="50" >
			<td width="40%" align="right" valign="bottom" style="border-left: solid;border-left-width: 2px">
				<font size="2">총 상품금액</font>
			</td>
			<td width="20%">
			</td>
			<td width="40%" align="right" valign="bottom" style="border-right: solid;border-right-width: 2px;padding-right: 30px;">
				<font size="3"><b>${totPrice }</b></font>
				<font size="2">원</font>
			</td>
		</tr>
		
		<tr height="50">
			<td width="40%" align="right" style="border-bottom: solid;border-bottom-color: #BDBDBD;border-bottom-width: 1px;border-left: solid;border-left-width: 2px">
				<font size="2">배송비</font>
			</td>
			<td width="20%"  style="border-bottom: solid;border-bottom-color: #BDBDBD;border-bottom-width: 1px;">
			</td>
			<td width="40%" align="right" style="border-bottom: solid;border-bottom-color: #BDBDBD;border-bottom-width: 1px;border-right: solid;border-right-width: 2px;padding-right: 30px;">
				<font size="3"><b>${deliveryFee }</b></font>
				<font size="2">원</font>
			</td>
		</tr>
		...
		<tr height="50">
			<td width="40%" align="right" style="border-bottom: solid;border-bottom-color: #BDBDBD;border-bottom-width: 1px;border-left: solid;border-left-width: 2px">
				<font size="3"><b>최종 결제금액</b></font>
			</td>
			<td width="20%"  style="border-bottom: solid;border-bottom-color: #BDBDBD;border-bottom-width: 1px;">
			</td>
			<td width="40%" align="right" style="border-bottom: solid;border-bottom-color: #BDBDBD;border-bottom-width: 1px;border-right: solid;border-right-width: 2px;padding-right: 30px;">
				<font size="3" color="red"><b>${totPrice+deliveryFee }</b></font>
				<font size="2" color="red">원</font>
			</td>
		</tr>
		
		<tr>
			<td colspan="3" align="center" style="border-left: solid;border-left-width: 2px;border-right: solid;border-right-width: 2px">
				<input type="hidden" value="${totPrice+deliveryFee }" name="totalCost"/> 
				<input type="button" value="  결재하기  " align="top" style="height: 50pt;width: 100pt;color: white;font-size: 18pt;background-color: #FF5E00;border: none;margin-top: 14px;" onclick="sendIt();">
				&nbsp;&nbsp;
				<input type="button" value="  취소  " align="top" style="height: 50pt;width: 100pt;color: blakc;font-size: 18pt;background-color: white;border: solid;border-width: 1px;border-color: black;margin-top: 14px;" onclick="javascript:location.href='<%=cp %>/goobnemall/product/listdetail.do?productNum=${dtoProduct.productNum }'">
			</td>
		</tr>
		<tr height="350px">
			<td colspan="3" style="border-left: solid;border-left-width: 2px;border-right: solid;border-right-width: 2px;border-bottom: solid;border-bottom-width: 2px"/>
		</tr>
	</table>
</form>
